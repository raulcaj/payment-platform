...
public class AccountServiceRestClient implements AccountService {
	...
	/* (non-Javadoc)
	 * @see br.com.raulcaj.transactionmodule.domain.AccountService#executeAccountLimitUpdate(java.lang.Long, org.springframework.data.util.Pair)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.com.raulcaj.transactionmodule.domain.AccountService#accountNotExist(java.lang.Long)
	 */
	@Override
